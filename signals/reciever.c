...
// Для запуска программы необходимо ввести в консоль ./reciever, если что-то пошло не так попробовать заново скомпилировать командой gcc emitter.c -o emitter и повторить первую инструкцию
